...
def main():
    ...
    for model_type in ['rob_base_imdb', 'imdb']:
        for epochs in ['3', '10']:
            for batch_size in ['16', '32']:
                for learning_rate in ['1e-5', '3e-6', '3e-5', '5e-5']:
                    #imdb_3_16_5e-5_output/
                    #rob_base_imdb_10_16_1e-5_output/
                    directory = 'outputs/' + model_type + '_' + epochs + '_' + batch_size + '_' + learning_rate + '_' + 'output'

                    if directory == "outputs/rob_base_imdb_10_16_3e-6_output":
                        continue
